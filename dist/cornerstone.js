/*! cornerstone-core - 2.2.8 - 2020-02-29 | (c) 2016 Chris Hafey | https://github.com/cornerstonejs/cornerstone */
...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "48dc27de375c1e7616b3";
...
function storedPixelDataToCanvasImageDataPseudocolorLUT(image, grayscaleLut, colorLut, canvasImageDataData) {
  ...
  var isPadding = typeof image.pixelPaddingValue !== 'undefined';

  if (minPixelValue < 0) {
    while (storedPixelDataIndex < numPixels) {
      var pixel = pixelData[storedPixelDataIndex++];
    ...
    while (storedPixelDataIndex < numPixels) {
      var _pixel = pixelData[storedPixelDataIndex++];

      if (isPadding && _pixel === image.pixelPaddingValue) {
        rgba = [0, 0, 0, 255];
      } else {
        grayscale = grayscaleLut[_pixel];
        rgba = clut[grayscale];
      }
